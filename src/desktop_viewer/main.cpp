...
.icad-drop-menu{position:absolute;z-index:3;right:12px;color:#e2e8f0}.icad-component-menu{top:58px}.icad-scene-menu{top:12px}.icad-drop-menu summary{cursor:pointer;list-style:none;padding:8px 12px;border:1px solid #475569;border-radius:9px;background:#111827e8;box-shadow:0 8px 24px #0005}.icad-drop-content{display:none;min-width:210px;max-height:52vh;overflow:auto;margin-top:6px;padding:8px;gap:5px;flex-direction:column;border:1px solid #475569;border-radius:10px;background:#0f172af2;box-shadow:0 16px 36px #0008}.icad-drop-menu[open] .icad-drop-content{display:flex}.icad-drop-content button{width:100%;text-align:left;color:#e2e8f0;background:#1e293b}.icad-drop-content button[aria-pressed=true]{border-color:#fbbf24;background:#3b2f16}.icad-view-cube{position:absolute;z-index:3;right:14px;bottom:14px;display:grid;grid-template-columns:repeat(3,32px);gap:3px;padding:7px;border:1px solid #475569;border-radius:12px;background:#0f172ae8;box-shadow:0 12px 30px #0008}.icad-view-cube button{width:32px;height:32px;padding:0;font-size:10px;color:#102030;background:#fff}.icad-view-cube button:first-child{grid-column:2}.icad-view-cube button:nth-child(6){font-weight:800;background:#dbeafe}
