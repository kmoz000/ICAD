...
IcadHighlighter::IcadHighlighter(QTextDocument* document) : QSyntaxHighlighter{document} {
    ...
    rules_ = {
        ...
        {expression(R"(\b(ASSEMBLY|INSTANCE|MATE|JOINT|FIXED|REVOLUTE|PRISMATIC|COINCIDENT|CONCENTRIC|PARALLEL|PERPENDICULAR|DISTANCE|ANGLE|SCENE|TRACK|KEYFRAME|PLAY|EVENT|POSE|LIMIT)\b)"), assembly},
