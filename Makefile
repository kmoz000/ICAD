...
quality:
	$(MAKE) BUILD_DIR=$(BUILD_DIR) CMAKE_FLAGS="-DICAD_WARNINGS_AS_ERRORS=ON -DICAD_ENABLE_SANITIZERS=OFF" test
	$(MAKE) BUILD_DIR=$(BUILD_DIR) CMAKE_FLAGS="-DICAD_WARNINGS_AS_ERRORS=ON -DICAD_ENABLE_SANITIZERS=ON" test
